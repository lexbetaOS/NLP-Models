...
- md_utils : 
    - sent_to_words : Esta función se encarga de tokenizar un texto eliminando signos de puntuación.
    - remove_stopwords : Esta función se encarga de eliminar los stopwords de un texto.
    - make_bigrams : Esta función se encarga de encontrar los bigrams en un texto.
    - make_trigrams : Esta función se encarga de encontrar los trigrams en un texto.
    - lemmatization : Esta función se encarga de lemmatizar el texto seleccionando solo los sustantivos, adjetivos, verbos y adverbios. 
    ...
    - multilayer_perceptron_nn : Esta funcion se encarga de realizar el Forward Propagation de la red neuronal definida.
